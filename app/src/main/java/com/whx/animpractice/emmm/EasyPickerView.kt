...
class EasyPickerView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {
    ...
    init {
        ...
        textSize = a.getDimensionPixelSize(R.styleable.EasyPickerView_epvTextSize, TypedValue.applyDimension(
        ...
        textPadding = a.getDimensionPixelSize(R.styleable.EasyPickerView_epvTextPadding, TypedValue.applyDimension(
    ...
    fun moveTo(index: Int) {
        ...
        if (!isRecycleMode) {
            ...
            val d2 = (dataList.size - Math.abs(offsetIndex)) * centerPadding
